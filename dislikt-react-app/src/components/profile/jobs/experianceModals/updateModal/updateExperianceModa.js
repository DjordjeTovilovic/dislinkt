...
const UpdateExperianceModal = (props) => {

    const reset = (e) => {
        props.updateExperianceHandler(e);
    }

    return(
        <> { props.showUpdateExperianceModal === true &&
            <Container>
                <Content>
                    <Header>
                    <h2>Update experiance</h2>
...
export default UpdateExperianceModal;